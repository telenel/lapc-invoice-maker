...
SELECT
  ...
  -- Keep existing view columns in-place and append new derived columns at the
  -- end so CREATE OR REPLACE VIEW stays valid on databases that already have
  -- the earlier products_with_derived definition.
